    ...
    <PageLayout>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-600">
          Total Energy Supply vs. Energy Services
        </p>
      </div>
      ...
      <div className="metric-card bg-white mb-8 pb-8" id="chart-efficiency-time">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">
              End to end conversion efficiency from primary energy to energy services
            </p>
          </div>
          <div className="flex gap-2">
            <ChartExportButtons
      ...
      <ChartFullscreenModal
        ...
        description="End to end conversion efficiency from primary energy to energy services"
        exportButtons={
          <ChartExportButtons
            onDownloadPNG={() => handleDownloadPNG('chart-efficiency-time', 'global_efficiency_over_time.png')}
            onDownloadCSV={() => {
      ...
      <div className="metric-card bg-white mb-8 border-2 border-blue-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-purple-600">
            ...
            <p className="text-gray-700">
              The percentage of primary energy that becomes energy services. Coal plants are ~32% efficient,
