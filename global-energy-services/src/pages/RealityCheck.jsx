      ...
      <div className="metric-card bg-white mb-8">
        <div className="space-y-10 text-gray-700 leading-relaxed text-base">
          ...
          <section>
            ...
            <p className="mb-4">
              Despite the hype surrounding the energy transition, <strong>82.9% of energy services</strong> (thermodynamic work potential) still come from fossil fuels. Hydrocarbons like oil, gas, and coal have several inherent advantages, which is why they are so deeply integrated into our energy systems. These advantages include:
            </p>
          ...
          <section>
            ...
            <p className="mb-4">
              One of the key takeaways from creating this platform was that it has identified that <strong>politics is actually what's slowing the energy transition down, not physics or technology</strong>. <strong>Without strong policies in place to accelerate the displacement rate and efficiency savings, the idea of an energy transition may continue to remain elusive.</strong> This is primarily because the demand for new energy services is so high that it's unrealistic to expect clean energy sources to grow fast enough to provide all of those energy services and also offset fossil fuel consumption.
            </p>
            <p className="mb-4">
