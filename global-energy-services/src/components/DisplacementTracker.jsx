...
export default function DisplacementTracker() {
  ...
  const calculateDisplacement = (data) => {
    ...
    Object.keys(periods).forEach(periodKey => {
      ...
      // Total Exergy Service Growth (Energy Services Demand)
      ...
      // Efficiency Savings = reduction in fossil energy services needed due to efficiency improvements
      // If efficiency improved, the fossil energy services that would have been needed at old efficiency
  ...
  const getStatusDescription = (status, periodLabel) => {
    ...
    switch (status) {
      case 'recarbonization':
        return `Clean energy services shrank ${periodText}. Fossil fuels expanded to meet all exergy demand.`;
      case 'rising':
